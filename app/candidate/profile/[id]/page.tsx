                             ...
                             <button 
                               onClick={async () => {
                                 ...
                                 try {
                                   ...
                                   if (conv) {
                                     router.push("/candidate/dashboard?tab=messages");
                                   } else {
                               ...
                               className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-6 py-2.5 bg-white/5 border border-white/10 hover:bg-white/10 text-white rounded-lg font-medium text-sm transition-colors"
                             >
